...
;
COMMENT ON COLUMN aktionen.a_b_id IS 'FK zu Brutstaetten'
;
COMMENT ON COLUMN aktionen.a_betreff IS 'Kurztitel'
;
COMMENT ON COLUMN aktionen.a_datum IS 'Timestamp'
;
COMMENT ON COLUMN aktionen.a_p_id IS 'FK zum Author'
;
...
END;
/
COMMENT ON COLUMN brutstaetten.b_a_id IS 'Bezug zu Aktionen'
;
...
;
COMMENT ON COLUMN brutstaetten.b_p_id IS 'Bezug zu Mitarbeiter'
;
...
; 
COMMENT ON COLUMN personen.p_g_id IS 'Referenz auf Geodaten'
;
COMMENT ON COLUMN personen.p_logname IS 'Loginname'
;
COMMENT ON COLUMN personen.p_text IS 'optionaler Zusatztext'
;
COMMENT ON COLUMN personen.p_typ IS 'normal, expert, admin'
;
...
;
ALTER TABLE brutstaetten
ADD CONSTRAINT b_a_id_fk FOREIGN KEY (b_a_id)
REFERENCES aktionen (a_id)
;
ALTER TABLE brutstaetten
